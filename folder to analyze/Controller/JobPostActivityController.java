...
import com.capstone.jobportal.entity.*;
import com.capstone.jobportal.services.*;
...
public class JobPostActivityController {
    ...
    public String addJobs(Model model) {
        List<Skills> allSkills = skillsService.getAllSkills();
        System.out.println("Skills: " + allSkills); // Debug log
    ...
    public String addNew(@ModelAttribute JobPostActivity jobPostActivity, Model model) {
    ...
    public String editJob(@PathVariable("id") int id, Model model) {
        ...
        model.addAttribute("jobPostActivity", jobPostActivity);
        model.addAttribute("allSkills", skillsService.getAllSkills()); // Add all skills to the model
        model.addAttribute("user", usersService.getCurrentUserProfile());
        return "add-jobs";
    }
    ...
    public String showJobDetails(@PathVariable("id") int id, Model model) {
        JobPostActivity jobPost = jobPostActivityService.getJobPostById(id);
        model.addAttribute("jobPost", jobPost);
        return "job-details";
    }
}